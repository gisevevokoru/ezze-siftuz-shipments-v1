...
class ShipmentsApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ShipmentsV1\Model\ForbiddenAddPositionItemByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ShipmentsV1\Model\ForbiddenAddPositionItemByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\EzzeSiftuz\ShipmentsV1\Model\Forbidden',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $limit The maximum number of shipments to be returned in each response. (optional)
     ...
     */
    public function listShipmentsUsingGET($datefrom, $limit = null, $next = null)
    {
     ...
     */
    public function listShipmentsUsingGETWithHttpInfo($datefrom, $limit = null, $next = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShipmentsUsingGETAsync($datefrom, $limit = null, $next = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShipmentsUsingGETAsyncWithHttpInfo($datefrom, $limit = null, $next = null)
    {
        $returnType = '\EzzeSiftuz\ShipmentsV1\Model\ShipmentList';
        $request = $this->listShipmentsUsingGETRequest($datefrom, $limit, $next);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listShipmentsUsingGETRequest($datefrom, $limit = null, $next = null)
    {
