...
self::CARRIER_HERMES,        ];
     ...
     * Sets carrier
     *
     * @param string $carrier The carrier for the return process, which can differ from the carrier used to deliver the shipment to the customer. Please be aware that this carrier can not differ from the chosen carrier in the OBC portal.
     *
     * @return $this
     */
